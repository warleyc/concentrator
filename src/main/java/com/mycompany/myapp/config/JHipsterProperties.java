...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "concentrator@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "concentrator API";

        private String description = "concentrator API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "concentrator";
